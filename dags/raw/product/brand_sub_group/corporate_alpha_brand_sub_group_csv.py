...
dag_config = parseJson.read_json_config(
    'dags/raw/product/brand_sub_group/corporate_alpha_brand_sub_group/config/corporate_alpha_brand_sub_group_config.json')
...
dag = DAG(
    'corporate_alpha_brand_sub_group_csv',

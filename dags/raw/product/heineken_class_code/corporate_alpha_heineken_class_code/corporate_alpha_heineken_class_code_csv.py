...
dag_config = parseJson.read_json_config(
    'dags/raw/product/heineken_class_code/corporate_alpha_heineken_class_code/config/corporate_alpha_heineken_class_code_config.json')
...
dag = DAG(
    'corporate_alpha_heineken_class_code_csv',

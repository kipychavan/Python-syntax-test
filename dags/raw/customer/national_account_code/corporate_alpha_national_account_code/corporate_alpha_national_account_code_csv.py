...
dag_config = parseJson.read_json_config(
    'dags/raw/customer/national_account_code/corporate_alpha_national_account_code/config/corporate_alpha_national_account_code_config.json')
...
dag = DAG(
    'corporate_alpha_national_account_code_csv',

...
dag_config = parseJson.read_json_config(
    'dags/raw/customer/beer_volume_indicator/corporate_alpha_beer_volume_indicator/config/corporate_alpha_beer_volume_indicator_config.json')
...
dag = DAG(
    'corporate_alpha_beer_volume_indicator_csv',

...
NULL,
'{{run_id}}',
md5(concat(COALESCE($1,0),COALESCE($2,'0'),COALESCE($3,'0'),COALESCE($4,'0'),COALESCE($5,'0'),COALESCE($6,'0'),COALESCE($7,'0'),COALESCE($8,'0'),COALESCE($9,'0'),COALESCE($10,'0'),COALESCE($11,'0'),COALESCE($12,'0'),COALESCE($20,'0'))),
'{{ params.fileName }}' 
from 

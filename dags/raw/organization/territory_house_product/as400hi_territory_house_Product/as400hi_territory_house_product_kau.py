...
dag_config = parseJson.read_json_config(
    'dags/raw/organization/territory_house_product/as400hi_territory_house_Product/config/as400hi_territory_house_product_config.json')
...
dag = DAG(
    'as400hi_territory_house_product_kau',

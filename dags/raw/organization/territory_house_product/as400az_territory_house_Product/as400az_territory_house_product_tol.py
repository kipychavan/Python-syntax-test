...
dag_config = parseJson.read_json_config(
    'dags/raw/organization/territory_house_product/as400az_territory_house_Product/config/as400az_territory_house_product_config.json')
...
dag = DAG(
    'as400az_territory_house_product_tol',

...
dag_config = parseJson.read_json_config(
    'dags/raw/pricing/programmer_type/corporate_alpha_programmer_type/config/corporate_alpha_programmer_type_config.json')
...
dag = DAG(
    'corporate_alpha_programmer_type_csv',
